...
The true population parameter value will be in the created interval 95%
of the time we create it.
...
No matter the distribution of the data, the distribution of the means of
the data will follow a normal distribution if the sample size is large.
...
As sample size enlarges, it represent an odd distribution.
